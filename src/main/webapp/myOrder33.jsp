...
<body>
	...
	<sql:query dataSource="${buydetails}" var="bd">
           		SELECT * FROM buydetails b join product p on b.p_id=p.p_id join shop s on p.s_id=s.s_id  where u_id='<%=session.getAttribute("id")%>' and bd_state='true' and bd_confirm="false" and bd_delivery='true'
            </sql:query>
	...
	<c:forEach items="${bd.rows}" var="b">
		<table class="bordered">
			...
			<tr>
				...
				<td width="15%">物流运输中<br/>订单详情<br/> <a href="#">查看物流</a>
				</td>
				<td width="16%"><a href="confirm?id=${b.bd_id}" onclick="return confirm1()">确认收货</a></td>
			</tr>
		</table>
	</c:forEach>
</body>
